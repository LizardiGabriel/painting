...
public class FunRsa {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JSONObject jsonKeys = generateRsaKeys();
     ...
     */
    public static JSONObject generateRsaKeys() throws NoSuchAlgorithmException {
     ...
     * @throws Exception
     */
    public static String decryptRsa(String cipherText, String privateKeyBase64) throws Exception {
